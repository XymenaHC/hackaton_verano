  ...
  {showCuriosities && (
    <div style={{position:'fixed',top:0,left:0,width:'100vw',height:'100vh',background:'rgba(0,0,0,0.5)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:1000}}>
      <div style={{background:'#fff',padding:24,borderRadius:12,maxWidth:400}}>
        <h3>Datos curiosos de Matrix</h3>
        <ul style={{textAlign:'left', color:'#222'}}>
          <li>La lluvia de código verde está inspirada en recetas de sushi.</li>
        </ul>
...
{showTimeline && (
  <div style={{position:'fixed',top:0,left:0,width:'100vw',height:'100vh',background:'rgba(0,0,0,0.5)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:1000}}>
    <div style={{background:'#fff',padding:24,borderRadius:12,maxWidth:400}}>
      <h3>Cronología de la saga Matrix</h3>
      <ul style={{textAlign:'left', color:'#222'}}>
        <li>1999 - Matrix</li>
        <li>2003 - Matrix Reloaded</li>
        <li>2003 - Matrix Revolutions</li>
        <li>2021 - Matrix Resurrections</li>
      </ul>
...
{showSimilares && (
  <div style={{position:'fixed',top:0,left:0,width:'100vw',height:'100vh',background:'rgba(0,0,0,0.5)',display:'flex',alignItems:'center',justifyContent:'center',zIndex:1000}}>
    <div style={{background:'#fff',padding:24,borderRadius:12,maxWidth:400}}>
      <h3>Películas similares a Matrix</h3>
      <ul style={{textAlign:'left', color:'#222'}}>
        <li>Inception (2010)</li>
        <li>Blade Runner (1982)</li>
        <li>Dark City (1998)</li>
